...
class SetupScriptGenerator {
    ...
    String unixJavaHome = "/opt/java7"
    String windowsJavaHome = "/opt/java7"
    ...
    String generateUnixScriptContent() {
        ...
        def binding = [applicationName: applicationName,
                ...
                javaHome: unixJavaHome]
        return generateNativeOutput('unixSetupScript.txt', binding, TextUtil.unixLineSeparator)
    }
    ...
    String generateWindowsScriptContent() {
        ...
        return generateNativeOutput('windowsSetupScript.txt', binding, TextUtil.windowsLineSeparator)
    ...
    private String generateNativeOutput(String templateName, Map binding, String lineSeparator) {
        def stream = SetupScriptGenerator.getResource(templateName)
